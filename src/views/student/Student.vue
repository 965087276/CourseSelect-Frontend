        ...
        <el-container>
            <el-aside>
                ...
                >
                    ...
                    <el-submenu index="preselect">
                        <template slot="title">
                            <i class="el-icon-location"></i>
                            <span>课程预选</span>
                        </template>
                        <el-menu-item index="preselect/my">我的预选</el-menu-item>
                    </el-submenu>
                    <el-submenu index="course-select">
                        <template slot="title">
                            <i class="el-icon-location"></i>
                            <span>选修课程</span>
                        </template>
                        ...
                        <el-menu-item index="course-select/my_course_list">我的课程</el-menu-item>
